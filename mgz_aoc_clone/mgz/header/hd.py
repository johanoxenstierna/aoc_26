...
from mgz_aoc_clone.mgz.enums import VictoryEnum, ResourceLevelEnum, AgeEnum, PlayerTypeEnum, DifficultyEnum
from mgz_aoc_clone.mgz.util import find_save_version
