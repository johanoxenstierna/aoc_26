...
from mgz_aoc_clone.mgz.enums import MyDiplomacyEnum, TheirDiplomacyEnum
from mgz_aoc_clone.mgz.header.objects import existing_object
from mgz_aoc_clone.mgz.header.playerstats import player_stats
from mgz_aoc_clone.mgz.util import Find, GotoObjectsEnd, RepeatUpTo, Version
