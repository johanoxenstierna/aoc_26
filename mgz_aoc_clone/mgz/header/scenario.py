...
from mgz_aoc_clone.mgz.enums import DifficultyEnum, PlayerTypeEnum, AgeEnum
from mgz_aoc_clone.mgz.util import Find, Version, find_save_version, find_version
