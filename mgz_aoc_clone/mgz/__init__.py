...
from mgz_aoc_clone.mgz.util import MgzPrefixed, ZlibCompressed, Version, VersionAdapter, get_version, get_save_version
from mgz_aoc_clone.mgz.header.ai import ai
from mgz_aoc_clone.mgz.header.replay import replay
from mgz_aoc_clone.mgz.header.map_info import map_info
from mgz_aoc_clone.mgz.header.initial import initial
from mgz_aoc_clone.mgz.header.achievements import achievements
from mgz_aoc_clone.mgz.header.scenario import scenario
from mgz_aoc_clone.mgz.header.lobby import lobby
from mgz_aoc_clone.mgz.header.de import de
from mgz_aoc_clone.mgz.header.hd import hd
